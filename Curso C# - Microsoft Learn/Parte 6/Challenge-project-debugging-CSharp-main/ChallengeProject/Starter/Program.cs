...
{
    int[] cashTillCopy = new int[cashTill.Length];
    Array.Copy(cashTill, cashTillCopy, cashTill.Length);
    ...
    cashTillCopy[3] += twenties;
    cashTillCopy[2] += tens;
    cashTillCopy[1] += fives;
    cashTillCopy[0] += ones;
    ...
    Array.Copy(cashTillCopy, cashTill, cashTillCopy.Length);
}
