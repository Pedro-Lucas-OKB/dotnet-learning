    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    ...
                    if (ourAnimals[i, 4] == "Physical description: tbt" || ourAnimals[i, 4] == "Physical description: ")
                    {
                        validEntry = false;
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 3] == "Nickname: tbt" || ourAnimals[i, 3] == "Nickname: ")
                    {
                        validEntry = false;
                    ...
                    if (ourAnimals[i, 5] == "Personality: tbt" || ourAnimals[i, 5] == "Personality: ")
                    {
                        validEntry = false;
