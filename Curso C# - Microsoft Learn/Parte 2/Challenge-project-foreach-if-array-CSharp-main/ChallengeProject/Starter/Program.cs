...
foreach (string name in studentNames)
{
    ...
    int sumAssignmentExtraCredits = 0;
    ...
    */
    foreach (int score in studentScores)
    {
        ...
        if (gradedAssignments <= examAssignments) {
            ...
            sumAssignmentExtraCredits += score;
        }
    }

    currentStudentExamScore = (decimal) (sumAssignmentScores) / examAssignments;
    currentStudentExtraCredit = (decimal) (sumAssignmentExtraCredits) / extraCreditsAssignments;
    currentStudentOverallGrade = (decimal)(sumAssignmentScores + ((decimal)sumAssignmentExtraCredits / 10)) / examAssignments;
    ...
    Console.WriteLine($"{currentStudent}\t\t{currentStudentExamScore}\t\t{currentStudentOverallGrade}\t{currentStudentLetterGrade}\t{currentStudentExtraCredit} ({currentStudentOverallGrade - currentStudentExamScore} pts)");
}
